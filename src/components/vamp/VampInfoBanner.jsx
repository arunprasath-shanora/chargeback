          ...
          {expanded && (
            <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-blue-800">
              <div className="bg-white rounded-xl p-3 border border-blue-100">
                ...
                <p>Early fraud warnings filed by issuers. Count is the primary numerator input for VAMP. From April 2025, RDR-resolved TC40s still count.</p>
              </div>
              <div className="bg-white rounded-xl p-3 border border-blue-100">
                <p className="font-semibold mb-1">📌 TC15 — Disputes / Chargebacks</p>
                <p>Actual chargeback / dispute records. Non-fraud disputes filed against the merchant. Can be auto-filled from your Dispute database.</p>
              </div>
              <div className="bg-white rounded-xl p-3 border border-blue-100">
                <p className="font-semibold mb-1">📌 TC05 — Settled Transactions</p>
                <p>Total settled CNP (Card-Not-Present) transactions for the month. This is the denominator. Must be imported from your processor.</p>
              </div>
              <div className="bg-white rounded-xl p-3 border border-blue-100">
                <p className="font-semibold mb-1">📌 CE3.0 / RDR Deduction</p>
                <p>Cases resolved via Compelling Evidence 3.0 or RDR can be deducted from the numerator (network-approved deductions only).</p>
              </div>
              <div className="bg-white rounded-xl p-3 border border-blue-100 sm:col-span-2">
                ...
                <div className="grid grid-cols-2 gap-2 mt-1">
                  <div>
                    ...
                    <p>Standard Monitor: ≥ 0.90%</p>
                    <p>Excessive: ≥ 1.80%</p>
                  </div>
                  <div>
                    <p className="font-medium">Mastercard</p>
                    <p>Standard (MCCM): ≥ 1.00%</p>
                    <p>Excessive (ECM): ≥ 1.50%</p>
                  </div>
                </div>
              </div>
            </div>
